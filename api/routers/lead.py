...
@router.get("/leads/", status_code=status.HTTP_200_OK, response_model=List[Leads])
...
@router.get("/leads/today", status_code=status.HTTP_200_OK, response_model=List[Leads])
async def get_leads(page: int = 1):
...
@router.get("/leads/yesterday", status_code=status.HTTP_200_OK, response_model=List[Leads])
async def get_leads(page: int = 1):
...
@router.get("/leads/one-week-ago", status_code=status.HTTP_200_OK, response_model=List[Leads])
async def get_leads(page: int = 1):
...
@router.get("/leads/week-to-date", status_code=status.HTTP_200_OK, response_model=List[Leads])
async def get_leads(page: int = 1):
    today = date.today()
...
@router.get("/leads/current-month", status_code=status.HTTP_200_OK, response_model=List[Leads])
async def get_leads(page: int = 1):
...
@router.get("/leads/last-month", status_code=status.HTTP_200_OK, response_model=List[Leads])
async def get_leads(page: int = 1):
...
@router.get("/leads/one-year-ago", status_code=status.HTTP_200_OK, response_model=List[Leads])
async def get_leads(page: int = 1):
